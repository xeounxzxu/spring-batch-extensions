...
public class StepDurationTrackerListener implements StepExecutionListener {
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        Optional<Duration> duration = resolveDuration(stepExecution.getStartTime(), stepExecution.getEndTime());
        ...
        if (stepExecution.getSkipCount() > 0) {
            log.warn("Step '{}' completed with {} skipped items.", stepExecution.getStepName(), stepExecution.getSkipCount());
